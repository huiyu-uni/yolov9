...
from utils.general import (DATASETS_DIR, LOGGER, NUM_THREADS, TQDM_BAR_FORMAT, check_dataset, check_requirements,
                           ...
                           xywh2xyxy, xywhn2xyxy, xyxy2xywhn, clip_boxes)
...
class LoadImagesAndLabels(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if mosaic:
            ...
            # Load image
            img, (h0, w0), (h, w), output_labels = self.load_image(index)
    ...
    def load_image(self, i):
        ...
        ### TODO: Load unlabeled images from given txt file
    ...
    def load_mosaic(self, index):
        ...
        for i, index in enumerate(indices):
            # Load image
            img, _, (h, w), output_labels = self.load_image(index)
...
def paste_in(img, crops, max_crops=10, orig_labels=[], max_iou=0.0):
    ...
    for each_crop in crops:
        ...
        ### Check whether the iou between crops and original labeled bboxes 
        if orig_labels.size and torch.max(box_iou(xyxy, orig_labels)) > max_iou:
            continue
        
        ### Check whether the iou between crops
